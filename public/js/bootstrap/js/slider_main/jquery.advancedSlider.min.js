(function (i) {
    function rb($, Q) {
        function aa() {
            ...
            q.children().each(function (e, c) {
                ...
                for (var d = 0; d < i(this).children().length; d++) {
                    ...
                    if (i(h).hasClass("thumbnail") || i(h).is("a") && i(h).children(".thumbnail").length)f.thumbnail = i(h).clone(); else if (i(h).hasClass("layer")) {
                        if (!f.layer)f.layer = [];
                        f.layer.push(i(h))
        ...
        function Ya() {
            s.addClass(a.settings.skin).css({width: a.settings.width, height: a.settings.height}).focus(function () {
                Ha = true;
                s.addClass("focus")
            }).blur(function () {
                Ha = false;
            ...
            if (R == "msie")if (parseInt(ja) ==
                6)s.addClass("ie6"); else if (parseInt(ja) == 7)s.addClass("ie7"); else if (parseInt(ja) == 8)s.addClass("ie8"); else parseInt(ja) == 9 && s.addClass("ie9");
            u = i('<div class="slide-wrapper"></div>').append(q).appendTo(O).hover(function () {
                ...
                if (a.settings.timerAnimation && a.settings.timerToggle && T != "stopped" && !U) {
                    ...
                    w ? c.show() : c.stop().animate({opacity: 1}, a.settings.timerFadeDuration)
                }
                if (Ia && a.settings.lightboxIconToggle) {
                    c = u.find(".lightbox-icon");
                    w ? c.css("filter", "") : c.stop().animate({opacity: 1},
                        a.settings.lightboxIconFadeDuration)
                }
                a.settings.pauseSlideshowOnHover && !N && oa();
                ua && a.settings.captionToggle && Db();
                if (a.settings.slideArrows && a.settings.slideArrowsToggle)w ? s.find(".slide-arrows a").stop().show() : s.find(".slide-arrows a").stop().animate({opacity: 1}, a.settings.slideArrowsShowDuration);
                if (a.settings.slideshowControls && a.settings.slideshowControlsToggle)w ? s.find(".slideshow-controls").stop().show() : s.find(".slideshow-controls").stop().animate({opacity: 1}, a.settings.slideshowControlsShowDuration);
                ...
                if (a.settings.timerAnimation && a.settings.timerToggle && T != "stopped" && !U) {
                    var c = s.find(".timer-animation");
                    w ? c.hide() : c.stop().animate({opacity: 0}, a.settings.timerFadeDuration)
                }
                if (Ia && a.settings.lightboxIconToggle) {
                    c = u.find(".lightbox-icon");
                    w ? c.css("opacity", 0) : c.stop().animate({opacity: 0}, a.settings.lightboxIconFadeDuration)
                }
                ...
                if (a.settings.slideshowControls && a.settings.slideshowControlsToggle)w ? s.find(".slideshow-controls").stop().hide() : s.find(".slideshow-controls").stop().animate({opacity: 0}, a.settings.slideshowControlsHideDuration)
            });
            a.settings.border || u.css("border", "none");
            a.settings.glow || u.css({"box-shadow": "none", "-moz-box-shadow": "none", "-webkit-box-shadow": "none"});
            a.settings.effectType == "swipe" && i('<div class="swipeable-container"></div>').appendTo(u).append(q);
            q.find(".slide").each(function (c) {
                var f = i(this), g = f.find("img.image");
                f = f.find(".caption");
                var d = y[c], h = d.properties;
                if (g.length) {
                    g.data("index", c);
            ...
            q.find(".layer.static").each(function () {
                ...
                var g = f.position ? f.position.toLowerCase() : "topleft", d = g.indexOf("right") != -1 ? "right" : "left";
                g = g.indexOf("bottom") != -1 ? "bottom" : "top";
                if (typeof f.horizontal !== "undefined")if (f.horizontal == "left" && d == "left" || f.horizontal ==
                    "right" && d == "right")c.css(d, 0); else if (f.horizontal == "right" && d == "left" || f.horizontal == "left" && d == "right") {
                    c.css("margin-" + d, -c.outerWidth(false));
                    c.css(d, "100%")
                } else if (f.horizontal == "center") {
                    c.css("margin-" + d, -c.outerWidth(false) * 0.5);
                    c.css(d, "50%")
                } else c.css(d, f.horizontal); else c.css(d, 0);
                if (typeof f.vertical !== "undefined")if (f.vertical == "top" && g == "top" || f.vertical == "bottom" && g == "bottom")c.css(g, 0); else if (f.vertical == "bottom" && g == "top" || f.vertical == "top" && g == "bottom") {
                    c.css("margin-" + g, -c.outerHeight(false));
                    c.css(g, "100%")
                } else if (f.vertical == "center") {
                    c.css("margin-" + g, -c.outerHeight(false) * 0.5);
                    c.css(g, "50%")
                } else c.css(g, f.vertical); else c.css(g, 0);
                c.css("visibility", "inherit").addClass("init")
            });
            q.find("video").each(function () {
                var c = i(this), f = c.parent();
                if (Ja) {
                    var g = c[0].outerHTML;
                    c.remove();
                    f.html(g);
            ...
            q.find(".jw-player").length && q.find(".jw-player").each(function (c) {
                ...
                video.find(".source").each(function () {
                    var f = i(this);
                    if (f.data("quality"))jwPlayerArgs.plugins = {"hd-2": {file: f.data("file")}}; else sources.push(i(this).data())
                });
                if (sources.length) {
                    if (sources.length == 1)jwPlayerArgs.file = sources[0].file; else jwPlayerArgs.levels = sources;
            ...
            q.find("a.video").length && q.find("a.video").each(function () {
                var c = i(this), f = c.children("img").attr("width"), g = c.children("img").attr("height");
                i(this).parent();
                ...
                c.click(function (h) {
                    ...
                    if (h.indexOf("youtube") != -1 || h.indexOf("youtu.be") != -1) {
                        j = /(\?|&)v\=([^&]*)(&|$)/;
                        j = h.match(j);
                        var p = j[2], k = "http://www.youtube.com/embed/" + p + "?enablejsapi=1&wmode=opaque&autoplay=1";
                        h = h.split("?")[1].split("&");
                    ...
                    if (a.settings.videoPlayAction == "stopSlideshow" && !N)Ka(); else a.settings.videoPlayAction == "pauseSlideshow" && !N && oa();
                    if (a.settings.leaveVideoAction ==
                        "removeVideo" || Ja || R == "msie" && parseInt(ja) <= 7)ba = j; else Gb()
                })
            });
        ...
        function pa() {
            ...
            if (a.settings.responsive) {
                s.css({
                    width: "100%",
                    maxWidth: a.settings.width, maxHeight: a.settings.height
                });
            ...
            if (a.settings.thumbnailType == "scroller" || a.settings.thumbnailType == "tooltipAndScroller")if (a.settings.fullscreenThumbnailScrollerOverlay && va == "on")if (a.settings.thumbnailOrientation == "horizontal")O.css("height", s.height()); else a.settings.thumbnailOrientation == "vertical" && O.css("width",
                s.width()); else if (!a.settings.thumbnailScrollerOverlay)if (a.settings.thumbnailOrientation == "horizontal")O.css("height", s.height() - v.outerHeight(true)); else a.settings.thumbnailOrientation == "vertical" && O.css("width", s.width() - v.outerWidth(true));
            if (a.settings.shadow) {
                var c = O.find(".shadow");
                if (va == "on" && !a.settings.fullscreenShadow || O.width() < 400)c.css("display", "none"); else {
                    c.css("display", "block");
                    var f = c.find(".shadow-middle"), g = c.find(".shadow-left").width() + c.find(".shadow-right").width(), d =
            ...
            u.css({height: O.height() - b, width: O.width() - e});
            Ib = u.width();
            Jb = u.height();
            q.find(".slide").each(function (h) {
                var j = i(this), p = j.find("img.image"), k = y[h].properties.alignType;
                if (p.length)if (p.data("loaded"))da(p, k); else {
            ...
            switch (a.settings.scaleType) {
                ...
                case "proportionalFit":
                    if (b.data("index") == o && b.data("loaded")) {
                        ...
                        if (C != -1) {
                            var c = x[C].find("img.image"), f = y[C].properties.alignType;
                            c.length && ca(c, f)
                        }
                    }
            }
        ...
        function ca(b, e) {
            ...
            switch (e) {
                case "leftTop":
                    ...
                    break;
                case "leftCenter":
                    b.css({left: 0, top: "50%", "margin-top": -f * 0.5});
                    break;
                case "leftBottom":
                    b.css({left: 0, bottom: 0});
                    break;
                case "centerTop":
                    b.css({left: "50%", top: 0, "margin-left": -c * 0.5});
                    break;
                case "centerCenter":
                    b.css({left: "50%", top: "50%", "margin-left": -c * 0.5, "margin-top": -f * 0.5});
                    break;
                case "centerBottom":
                    b.css({left: "50%", bottom: 0, "margin-left": -c * 0.5});
                    break;
                case "rightTop":
                    b.css({right: 0, top: 0});
                    break;
                case "rightCenter":
                    b.css({right: 0, top: "50%", "margin-top": -f * 0.5});
                    break;
                case "rightBottom":
                    b.css({
                        right: 0,
        ...
        function ub() {
            var b = i('<div class="slide-arrows"></div>').appendTo(u), e = i('<a class="previous"></a>').appendTo(b).click(function () {
                ma = "previousButton";
                wa()
            });
        ...
        function fa() {
            ...
            b.addClass(e).click(function () {
                if (T == "playing" || T == "paused")Za(); else T == "stopped" && Kb()
            });
            if (a.settings.slideshowControlsToggle)w ? b.hide() : b.css("opacity", 0)
        }

        function La() {
            var b = K, e = i('<div class="slide-buttons"></div>').appendTo(O);
            ...
            if (a.settings.slideButtonsToggle) {
                ...
                s.hover(function () {
                    w ? e.show() : e.stop().animate({opacity: 1}, a.settings.slideButtonsShowDuration)
                }, function () {
                    w ? e.hide() : e.stop().animate({opacity: 0}, a.settings.slideButtonsHideDuration)
                })
            }
        }
        ...
        function Ma() {
            i(document).keydown(function (b) {
                ...
                else if (b.which == 39 && (a.settings.keyboardNavigationOnFocusOnly && Ha || !a.settings.keyboardNavigationOnFocusOnly))ra(); else b.which == 13 && Ha && x[o].children("a").length && x[o].children("a").not(".thumbnail")[0].click()
            })
        }
        ...
        function Da() {
            ...
            b.click(function () {
                if (va == "off")if ($.requestFullScreen)$.requestFullScreen(); else if ($.mozRequestFullScreen)$.mozRequestFullScreen(); else $.webkitRequestFullScreen && $.webkitRequestFullScreen(); else if (va == "on")if (document.cancelFullScreen)document.cancelFullScreen();
                else if (document.mozCancelFullScreen)document.mozCancelFullScreen(); else document.webkitCancelFullScreen && document.webkitCancelFullScreen()
            });
            ...
            if (a.settings.fullscreenControlsToggle && !ea)b.css("opacity", 0); else w || b.css({opacity: 0}).stop().animate({opacity: 1}, a.settings.fullscreenIconHideDuration);
            a.settings.fullscreenControlsToggle && u.hover(function () {
                w ?
                    b.css("filter", "") : b.stop().animate({opacity: 1}, a.settings.fullscreenIconShowDuration)
            }, function () {
                w ? b.css("opacity", 0) : b.stop().animate({opacity: 0}, a.settings.fullscreenIconHideDuration)
            })
        }
        ...
        function M() {
            ...
            if (va == "on") {
                s.css({width: "100%", height: "100%"}).addClass("fullscreen");
                v && a.settings.fullscreenThumbnailScrollerOverlay && v.addClass("overlay")
            } else {
                s.css({width: a.settings.width, height: a.settings.height}).removeClass("fullscreen");
        ...
        function $a(b) {
            if (y[b].thumbnail) {
                var e = y[b].thumbnail.hasClass("thumbnail") && !y[b].thumbnail.is("img"), c = i('<div class="thumbnail-wrapper"></div>').appendTo(s.find(".buttons-inner")), f;
                if (e) {
                ...
                c.css({width: f.outerWidth(false), height: f.outerHeight(false)});
                ...
                c.css({
                    left: b, top: e -
                    a.settings.thumbnailSlideAmount, opacity: 0
                });
                if (w) {
                    c.animate({top: e, opacity: 1}, a.settings.thumbnailSlideDuration, a.settings.thumbnailSlideEasing);
                    c.find(".caption .background").animate({opacity: h}, a.settings.thumbnailSlideDuration)
                } else c.animate({
                    top: e,
                    opacity: 1
        ...
        function Qa() {
            ...
            if (b.length) {
                ...
                w && e.animate({opacity: 0}, a.settings.thumbnailSlideDuration);
                b.animate({
                    top: b.position().top -
                    a.settings.thumbnailSlideAmount, opacity: 0
        ...
        function qa(b) {
            if (b != o) {
                if (U || ab)if (a.settings.overrideTransition)switch (Lb) {
                    case "slide":
                ...
                if (Ia) {
                    ...
                    w ? e.remove() : e.stop().animate({opacity: 0}, a.settings.lightboxIconFadeDuration, function () {
                        e.remove()
                    })
                }
                if (ba) {
                ...
                if (o != sa)if (ua && a.settings.effectType != "swipe") {
                    ua = false;
                    tb();
                    Ra && clearTimeout(Ra)
                }
                ...
                b = {type: "slideOpen", index: o, data: c};
        ...
        function ac(b) {
            var e = [];
            if (!(K <= 1)) {
                if (K == 2)if (b == 0)e.push(1); else b == 1 && e.push(0); else if (K >= 3)e.push(b == 0 ? K - 1 : b - 1, b == K - 1 ? 0 : b + 1);
                for (b = 0; b < e.length; b++) {
                    var c = e[b], f = y[c];
                    if (f.lazyImage && !f.lazyImageLoaded) {
                        var g = x[c].find("img.image"), d = i('<img class="image"/>').attr("src",
                            f.lazyImage), h = f.properties.alignType;
        ...
        function Mb(b) {
            if (!b.find(".preloader").length) {
                var e = i('<div class="preloader"></div>').hide().appendTo(b), c = (b.outerWidth(true) - e.width()) * 0.5;
        ...
        function xb() {
            ...
            if (a.settings.effectType == "swipe")b = "swipe"; else if (b == "random")b = Ea(["slice", "slide", "fade"]);
            Lb = b;
            var e = y[o];
            x[o].hover(function () {
                var f = {type: "slideMouseOver", index: o, data: e};
                i.isFunction(a.settings.slideMouseOver) && a.settings.slideMouseOver.call(this, f)
            }, function () {
                var f = {type: "slideMouseOut", index: o, data: e};
                i.isFunction(a.settings.slideMouseOut) &&
                a.settings.slideMouseOut.call(this, f)
            }).click(function () {
                var f = {type: "slideClick", index: o, data: e};
                i.isFunction(a.settings.slideClick) && a.settings.slideClick.call(this, f)
            });
            var c = {type: "transitionStart", index: o, data: y[o]};
        ...
        function S() {
            var b = y[o], e = parseInt(b.properties.captionDelay);
            U = false;
            if (a.settings.slideshow && T != "stopped")if (!a.settings.slideshowLoop && o == K - 1)Za(); else {
                bb();
            ...
            if (c.length &&
                ...
                if (e == "video")f.addClass("play"); else if (e == "link")f.addClass("hyperlink"); else e == "image" && f.addClass("magnifying");
                if (a.settings.lightboxIconToggle && !ea)f.css("opacity", 0); else w || f.css({opacity: 0}).stop().animate({opacity: 1}, a.settings.lightboxIconFadeDuration);
                f.click(function () {
                    a.settings.effectType == "swipe" && c.unbind("click.prettyphoto").bind("click.prettyphoto", {instance: Na}, i.prettyPhoto.initialize);
                    c.trigger("click")
                })
            }
            ...
            x[o].children(".layer").not(".static, .init").each(function () {
                ...
                var p = d.position ? d.position.toLowerCase() : "topleft", k = p.indexOf("right") != -1 ? "right" : "left", l = p.indexOf("bottom") != -1 ? "bottom" : "top";
                if (typeof d.horizontal !== "undefined")if (d.horizontal == "left" && k == "left" || d.horizontal == "right" && k == "right")g.css(k, 0); else if (d.horizontal == "right" && k == "left" || d.horizontal == "left" && k == "right") {
                    g.css("margin-" + k, -g.outerWidth(false));
                    g.css(k, "100%")
                } else if (d.horizontal == "center") {
                    g.css("margin-" + k, -g.outerWidth(false) * 0.5);
                    g.css(k, "50%")
                } else g.css(k, d.horizontal); else g.css(k, 0);
                if (typeof d.vertical !== "undefined")if (d.vertical == "top" && l == "top" || d.vertical == "bottom" && l == "bottom")g.css(l, 0); else if (d.vertical == "bottom" && l == "top" || d.vertical == "top" && l == "bottom") {
                ...
                if (typeof d.transition !== "undefined") {
                    ...
                    if (d.transition == "left")j[k] = p + (k == "left" ? m : -m); else if (d.transition == "right")j[k] = p + (k == "left" ? -m : m); else if (d.transition == "up")j[l] = n + (l == "top" ? m : -m); else if (d.transition ==
                ...
                R == "msie" && parseInt(ja) <= 7 ? g.css("visibility", "inherit").css(h) : g.addClass("init").delay(d.delay).css(j).css("visibility", "inherit").animate(h, d.duration, d.easing, function () {
                    if (d.horizontal)if (d.horizontal == "left" && k == "left" || d.horizontal == "right" && k == "right")g.css(k, 0); else if (d.horizontal == "right" && k == "left" || d.horizontal == "left" && k == "right") {
                        g.css("margin-" + k, -g.outerWidth(false));
                        g.css(k, "100%")
                    } else if (d.horizontal == "center") {
                        g.css("margin-" + k, -g.outerWidth(false) *
                    ...
                    if (d.vertical)if (d.vertical == "top" && l == "top" || d.vertical == "bottom" && l == "bottom")g.css(l, 0); else if (d.vertical == "bottom" && l == "top" || d.vertical == "top" && l == "bottom") {
                        g.css("margin-" + l, -g.outerHeight(false));
                        g.css(l, "100%")
                    } else if (d.vertical == "center") {
                        g.css("margin-" + l, -g.outerHeight(false) * 0.5);
        ...
        function Gb() {
            if (i.fn.videoController) {
                ...
                if (x[o].find("iframe").length) {
                    var c = x[o].find("iframe"), f = c.attr("src");
                ...
                if (b) {
                    if (y[o].videoInstance)ba = y[o].videoInstance; else {
                        ba = b.videoController({
                            videoType: e,
                            reachVideoAction: a.settings.reachVideoAction,
                            leaveVideoAction: a.settings.leaveVideoAction,
                            start: function () {
                                if (a.settings.videoPlayAction == "stopSlideshow" && !N)Ka(); else a.settings.videoPlayAction ==
                                "pauseSlideshow" && !N && oa()
                            },
                            play: function () {
                                sb = true;
                                if (a.settings.videoPlayAction == "stopSlideshow" && !N)Ka(); else a.settings.videoPlayAction == "pauseSlideshow" && !N && oa();
                                var g = {type: "videoPlay"};
                                i.isFunction(a.settings.videoPlay) && a.settings.videoPlay.call(this, g)
                            },
                            pause: function () {
                                if (a.settings.videoPauseAction == "startSlideshow" && !N)bb(); else a.settings.videoPauseAction == "resumeSlideshow" && !N && Ba();
                                var g = {type: "videoPause"};
                                i.isFunction(a.settings.videoPause) && a.settings.videoPause.call(this, g)
                            },
                            end: function () {
                                if (a.settings.videoEndAction ==
                                    "resetVideo")ba.stopVideo(); else if (a.settings.videoEndAction == "replayVideo")ba.replayVideo(); else if (a.settings.videoEndAction == "startSlideshow" && !N)bb(); else if (a.settings.videoEndAction == "resumeSlideshow" && !N)Ba(); else a.settings.videoEndAction == "nextSlide" && ra();
                                var g = {type: "videoEnd"};
                                i.isFunction(a.settings.videoEnd) && a.settings.videoEnd.call(this, g)
                            },
                            fullscreenchange: function () {
                                if (R == "msie")if (i("body").hasClass("vjs-full-window")) {
                                ...
                                var g = {type: "videoFullscreenChange"};
        ...
        function Ob() {
            var b = y[o].properties, e = x[o], c, f = parseInt(b.fadeInDuration), g = b.fadeInEasing, d = parseInt(b.fadeOutDuration);
            b = b.fadeOutEasing;
            ...
            e.css({visibility: "visible", opacity: 0}).animate({opacity: 1}, f, g, function () {
                e.css({opacity: ""});
                S()
            });
            if (C != -1) {
                ...
                c.animate({opacity: 0}, d, b, function () {
                    c.css({visibility: "", opacity: ""})
                })
            }
        }

        function cc() {
            var b = y[o].properties, e = x[o], c, f = b.slideDirection, g = parseInt(b.slideDuration),
                d = b.slideEasing;
            b = b.slideLoop;
            if (C != -1)c = x[C];
            ...
            h[j] = 0;
            e.animate(h, {
                duration: g, easing: d, complete: function () {
                    e.css({left: "", top: ""});
                    C != -1 && c.css({visibility: "", left: "", top: ""});
                    S()
                }, step: function (k) {
                    c && c.css(j, k - p)
                }
            ...
            if (C == -1) {
                q.css("overflow", "visible").bind("dragstart", W).find(".slide").each(function (g) {
                    ...
                    if (a.settings.swipeOrientation == "horizontal")d.css({
                        top: 0,
                        left: g * (q.width() + a.settings.swipeSlideDistance), visibility: "visible"
                ...
                if (a.settings.swipeOrientation == "horizontal") {
                    ...
                    c && q.swipe({
                        ...
                        excludedElements: [], allowPageScroll: "vertical", swipeStatus: function (g, d, h, j) {
                            if (d == "start") {
                                ...
                                if (h == "left")q.css("left", b - j * e); else h == "right" && q.css("left", b + j * e)
                            } else if (d == "cancel") {
                                q.stop().animate({
                                    left: -o *
                            ...
                            if (g.length) {
                                g.unbind("click", W);
                                g.attr("rel") && i.prettyPhoto && g.unbind("click.prettyphoto").bind("click.prettyphoto", {instance: Na}, i.prettyPhoto.initialize)
                            }
                        }, swipeLeft: function () {
                            o < K - 1 ? ra() : q.stop().animate({left: -o * (q.width() + a.settings.swipeSlideDistance)}, a.settings.swipeBackDuration,
                                a.settings.swipeEasing, function () {
                                    U && S()
                                });
                            a.settings.swipeGrabCursor && q.removeClass("grabbing").addClass("grab")
                        }, swipeRight: function () {
                            o > 0 ? wa() : q.stop().animate({left: -o * (q.width() + a.settings.swipeSlideDistance)}, a.settings.swipeBackDuration, a.settings.swipeEasing, function () {
                                U && S()
                            });
                            a.settings.swipeGrabCursor && q.removeClass("grabbing").addClass("grab")
                        }
                    ...
                    c && q.swipe({
                        threshold: a.settings.swipeThreshold,
                        excludedElements: [], allowPageScroll: "horizontal", swipeStatus: function (g, d, h, j) {
                            if (d == "start") {
                                ...
                                if (h == "up")q.css("top", b - j * e); else h == "down" && q.css("top", b + j * e)
                            } else if (d == "cancel") {
                                q.stop().animate({
                                    top: -o *
                            ...
                            o < K - 1 ? ra() : q.stop().animate({top: -o * (q.height() + a.settings.swipeSlideDistance)}, a.settings.swipeBackDuration, a.settings.swipeEasing,
                                function () {
                                    U && S()
                                });
                            a.settings.swipeGrabCursor && q.removeClass("grabbing").addClass("grab")
                        }, swipeDown: function () {
                            o > 0 ? wa() : q.stop().animate({top: -o * (q.height() + a.settings.swipeSlideDistance)}, a.settings.swipeBackDuration, a.settings.swipeEasing, function () {
                                U && S()
                            });
                            a.settings.swipeGrabCursor && q.removeClass("grabbing").addClass("grab")
                        }
                ...
                S()
            } else if (a.settings.swipeOrientation == "horizontal")q.stop().animate({left: -o * (q.width() + a.settings.swipeSlideDistance)}, a.settings.swipeDuration, a.settings.swipeEasing,
                function () {
                    if (i.support.transition && !q.is(":animated"))S(); else i.support.transition || S()
                }); else a.settings.swipeOrientation == "vertical" && q.stop().animate({top: -o * (q.height() + a.settings.swipeSlideDistance)}, a.settings.swipeDuration, a.settings.swipeEasing, function () {
                if (i.support.transition && !q.is(":animated"))S(); else i.support.transition || S()
            })
        }

        function ec() {
            var b = y[o], e = b.properties, c = e.sliceEffectType, f = e.htmlDuringTransition, g = parseInt(e.horizontalSlices), d = parseInt(e.verticalSlices), h = e.slicePattern,
                j = e.slicePoint, p = e.sliceStartPosition, k = parseFloat(e.sliceStartRatio), l = parseInt(e.sliceDuration), n = e.sliceEasing, m = parseInt(e.sliceDelay), t = e.sliceFade == true || effectType == "fade" ? 0 : 1, z = e.fadePreviousSlide, B = parseInt(e.fadePreviousSlideDuration), A = Math.floor(u.width() / g), H = Math.floor(u.height() / d);
            ...
            if (C != -1 && z == true) {
                ...
                db.animate({opacity: 0}, B, function () {
                    db.css({visibility: "", opacity: ""});
                    w && db.find("*").each(function () {
            ...
            for (e = 0; e < g; e++)for (f = 0; f < d; f++) {
                z = i('<div class="slice"></div>').css({
                    left: e *
                    A, top: f * H, width: A, height: H, opacity: t, display: "none"
                }).data({hPos: e, vPos: f}).appendTo(xa);
                var eb;
        ...
        function gc(b, e, c, f, g, d, h, j, p) {
            var k = {}, l = {}, n = parseInt(b.css("width")), m = parseInt(b.css("height")), t = parseInt(b.css("left")), z = parseInt(b.css("top")),
                B, A;
            ...
            switch (c) {
                case "fade":
                    ...
                    break;
                case "scale":
                    k = {width: 0, height: 0, left: B, top: A};
                    l = {width: n, height: m, left: t, top: z, opacity: 1};
                    break;
                case "width":
                    k =
                    {width: 0, left: B};
                    l = {width: n, left: t, opacity: 1};
                    break;
                case "height":
                    k = {height: 0, top: A};
                    l = {height: m, top: z, opacity: 1};
                    break;
                case "slide":
                    k = {left: B, top: A};
                    l = {left: t, top: z, opacity: 1};
                    break;
                default:
                    l = {opacity: 1}
            }
        ...
        function Db() {
            sa = o;
            var b = y[sa].properties, e = b.captionPosition, c = b.captionSize, f = b.captionWidth, g = b.captionHeight, d = b.captionLeft, h = b.captionTop, j = b.captionShowEffect, p = parseInt(b.captionShowEffectDuration), k = b.captionShowEffectEasing, l = b.captionShowSlideDirection;
            f = e == "custom" ? f : "100%";
            g = e == "custom" ? g : "100%";
            d = e == "custom" ? d : 0;
            h = e == "custom" ? h : 0;
            var n = x[o].find(".caption-container"), m = n.find(".wrapper");
            m.find(".background");
            m.find(".caption");
            ...
            switch (e) {
                case "left":
                    n.css({width: c, height: g, left: d, top: h});
                    l == "auto" && m.css({width: c, height: g, left: -t, top: 0});
                    break;
                case "right":
                    n.css({width: c, height: g, right: d, top: h});
                    l == "auto" && m.css({width: c, height: g, left: t, top: 0});
                    break;
                case "top":
                    n.css({width: f, height: c, left: d, top: h});
                    l == "auto" && m.css({width: f, height: c, left: 0, top: -t});
                    break;
                case "bottom":
                    n.css({width: f, height: c, left: d, bottom: h});
                    l == "auto" && m.css({width: f, height: c, left: 0, top: t});
                    break;
                case "custom":
                    n.css({
                        width: f,
                        height: g, left: d, top: h
                    });
                    m.css({width: f, height: g, left: 0, top: 0});
                    break;
                case "default":
                    n.css({width: f, height: c, left: d, bottom: h});
                    l == "auto" && m.css({width: f, height: c, left: 0, top: t})
            }
            if (j == "fade")w ? n.css("visibility", "visible") : m.stop().css({opacity: 0}).animate({opacity: 1}, p, k); else {
                w ? n.css("visibility", "visible") : m.stop().css({opacity: 1});
                e == "custom" && n.css({width: f, height: g, left: d, top: h});
                if (l == "topToBottom")m.css({
                    ...
                    left: -n.width(),
                    top: 0
                }); else l == "rightToLeft" && m.css({width: f, height: g, left: n.width(), top: 0});
                R == "msie" && ja == "6.0" && m.css("background-color", b);
                m.stop().animate({top: 0, left: 0}, p, k)
            }
        }

        function tb() {
            if (sa != -1) {
                var b = x[sa].find(".caption-container"), e = b.find(".wrapper");
                e.find(".background");
                e.find(".caption");
                var c = y[sa].properties, f = c.captionPosition, g = c.captionHideEffect, d = parseInt(c.captionHideEffectDuration), h = c.captionHideEffectEasing;
                c = c.captionHideSlideDirection;
                if (g == "fade")w ? b.css("visibility", "hidden") : e.stop().animate({opacity: 0}, d, h); else if (c == "topToBottom")e.animate({top: e.height()}, d); else if (c == "bottomToTop")e.animate({top: -e.height()}, d); else if (c == "leftToRight")e.animate({left: e.width()}, d); else if (c == "rightToLeft")e.animate({left: -e.width()}, d); else if (c == "auto")switch (f) {
                    case "left":
                        e.stop().animate({left: -e.width()}, d);
                        break;
                    case "right":
                        e.stop().animate({left: e.width()}, d);
                        break;
        ...
        function bb() {
            ...
            ha = setTimeout(function () {
                ma = "slideshow";
                if (a.settings.slideshowDirection == "next")ra(); else a.settings.slideshowDirection == "previous" && wa()
            }, b)
        }
        ...
        function hc(b) {
            ...
            if (a.settings.timerToggle && !ea)w ? A.hide() : A.css("opacity", 0); else w || A.css({opacity: 0}).stop().animate({opacity: 1}, a.settings.timerFadeDuration);
            var H;
            if (e.getContext)H = e.getContext("2d"); else if (typeof G_vmlCanvasManager != "undefined" && w)H = G_vmlCanvasManager.initElement(e).getContext("2d"); else return;
            H.beginPath();
        ...
        function ic() {
            ...
            if (b)w ? b.remove() : b.stop().animate({opacity: 0}, a.settings.timerFadeDuration, function () {
                b.remove()
            })
        }
        ...
        function $b() {
            ...
            v.addClass("overlay");
            for (var b = 0; b < K; b++)if (y[b].thumbnail && (y[b].properties.thumbnailType == "scroller" || y[b].properties.thumbnailType == "tooltipAndScroller")) {
                var e = y[b].thumbnail.hasClass("thumbnail") && !y[b].thumbnail.is("img"), c = i('<div class="thumbnail-wrapper"></li>').appendTo(J);
                if (e) {
                    e = y[b].thumbnail;
                    ...
                    var f = (e = y[b].thumbnail.is("a")) ? y[b].thumbnail.find("img").removeClass("thumbnail") :
                        y[b].thumbnail, g = f.attr("src"), d = f.attr("alt");
                    f.attr("title");
                    if (e) {
                        e = y[b].thumbnail;
                    ...
                    if (d && a.settings.thumbnailCaption) {
                        ...
                        a.settings.thumbnailCaptionPosition == "top" ? f.css({top: 0}) : f.css({bottom: 0});
                        if (a.settings.thumbnailCaptionToggle)if (a.settings.thumbnailCaptionEffect == "slide")a.settings.thumbnailCaptionPosition == "top" ? f.css({top: -f.outerHeight(true)}) : f.css({bottom: -f.outerHeight(true)}); else if (w) {
                    ...
                    if (g || h) {
                        ...
                        if (d == "video")f.addClass("play"); else if (d == "link")f.addClass("hyperlink"); else d ==
                ...
                c.css({width: e.outerWidth(false), height: e.outerHeight(false)});
                ...
                e.hover(function () {
                    ...
                    if (a.settings.thumbnailCaptionToggle) {
                        var l = i(this).children(".caption"), n = l.children(".background"), m = l.children(".content"), t = n.data("opacity");
                        if (a.settings.thumbnailCaptionEffect ==
                            "slide")a.settings.thumbnailCaptionPosition == "top" ? l.stop().animate({top: 0}, a.settings.thumbnailCaptionShowDuration, a.settings.thumbnailCaptionEasing) : l.stop().animate({bottom: 0}, a.settings.thumbnailCaptionShowDuration, a.settings.thumbnailCaptionEasing); else if (w) {
                            n.stop().animate({opacity: t}, a.settings.thumbnailCaptionShowDuration, a.settings.thumbnailCaptionEasing);
                            m.stop().animate({opacity: 1}, a.settings.thumbnailCaptionShowDuration, a.settings.thumbnailCaptionEasing)
                        } else l.stop().animate({opacity: 1},
                    ...
                    if (a.settings.thumbnailLightboxIconToggle) {
                        ...
                        w ? l.css("filter", "") : l.stop().animate({opacity: 1}, a.settings.lightboxIconFadeDuration)
                    }
                    a.settings.thumbnailTooltip && jc(k);
                    k = {type: "thumbnailMouseOver", index: k};
                    i.isFunction(a.settings.thumbnailMouseOver) && a.settings.thumbnailMouseOver.call(this, k)
                }, function () {
                    i(this).hasClass("select") || i(this).removeClass("over");
                    var k = parseInt(i(this).data("index"));
                    if (a.settings.thumbnailCaptionToggle) {
                        var l = i(this).children(".caption"), n = l.children(".background"), m = l.children(".content");
                        if (a.settings.thumbnailCaptionEffect == "slide")a.settings.thumbnailCaptionPosition == "top" ? l.stop().animate({top: -l.outerHeight(true)}, a.settings.thumbnailCaptionHideDuration, a.settings.thumbnailCaptionEasing) : l.stop().animate({bottom: -l.outerHeight(true)}, a.settings.thumbnailCaptionHideDuration, a.settings.thumbnailCaptionEasing); else if (w) {
                            n.stop().animate({opacity: 0}, a.settings.thumbnailCaptionHideDuration,
                                a.settings.thumbnailCaptionEasing);
                            m.stop().animate({opacity: 0}, a.settings.thumbnailCaptionHideDuration, a.settings.thumbnailCaptionEasing)
                        } else l.stop().animate({opacity: 0}, a.settings.thumbnailCaptionHideDuration, a.settings.thumbnailCaptionEasing)
                    }
                    if (a.settings.thumbnailLightboxIconToggle) {
                        l = i(this).children(".lightbox-icon");
                        w ? l.css("opacity", 0) : l.stop().animate({opacity: 0}, a.settings.lightboxIconFadeDuration)
                    }
                    a.settings.thumbnailTooltip && kc(k);
                    k = {type: "thumbnailMouseOut", index: k};
                ...
                if (!a.settings.thumbnailSwipe || w)e.click(function () {
                    ...
                    ma = "thumbnail";
                    var l = {type: "thumbnailClick", index: k};
            ...
            if (a.settings.thumbnailOrientation == "horizontal") {
                v.css({
                    height: Y *
                    F, width: X * a.settings.maximumVisibleThumbnails
                });
                D.css({height: Y * F, width: X * a.settings.maximumVisibleThumbnails})
            } else {
                v.css({width: X * F, height: Y * a.settings.maximumVisibleThumbnails});
                D.css({width: X * F, height: Y * a.settings.maximumVisibleThumbnails})
            }
            ...
            wb();
            a.settings.thumbnailScrollerToggle && v.css({opacity: 0});
            v.hover(function () {
                yb = true;
                if (a.settings.thumbnailScrollerToggle)w ? v.css("filter", "") : v.stop().animate({opacity: 1}, a.settings.thumbnailScrollerShowDuration)
            }, function () {
                yb = false;
                if (a.settings.thumbnailScrollerToggle)w ? v.css("opacity", 0) : v.stop().animate({opacity: 0}, a.settings.thumbnailScrollerHideDuration)
            });
                ...
                if (b && a.settings.thumbnailOrientation == "horizontal")D.swipe({
                    ...
                    swipeStatus: function (k, l, n, m) {
                        if (l == "start") {
                            ...
                            if (n == "left")J.css("left", j - m * p); else n == "right" && J.css("left", j + m * p);
                            Ga()
                        } else if (l == "cancel") {
                    ...
                    click: function (k) {
                        ...
                        if (k.length) {
                            ...
                            ma = "thumbnail";
                            k.unbind("click", W);
                            k.attr("rel") && i.prettyPhoto && k.unbind("click.prettyphoto").bind("click.prettyphoto", {instance: Na}, i.prettyPhoto.initialize);
                            var n = {type: "thumbnailClick", index: l};
                ...
                "vertical" && D.swipe({
                    ...
                    swipeStatus: function (k, l, n, m) {
                        if (l == "start") {
                            ...
                            if (n == "up")J.css("top",
                                j - m * p); else n == "down" && J.css("top", j + m * p);
                            Ga()
                        } else if (l == "cancel") {
                            m != 0 && V(L, a.settings.thumbnailSwipeBackDuration);
                            a.settings.thumbnailSwipeGrabCursor && D.removeClass("grabbing").addClass("grab");
        ...
        function wb() {
            v.find(".thumbnail-wrapper").each(function (e) {
                var c = i(this);
                c.css({width: c.find(".thumbnail").outerWidth(false), height: c.find(".thumbnail").outerHeight(false)});
                X = c.outerWidth(true);
            ...
            if (a.settings.thumbnailScrollerCenter)if (a.settings.thumbnailOrientation == "horizontal")v.css("left", (O.outerWidth(false) - v.outerWidth(false)) / 2); else a.settings.thumbnailOrientation == "vertical" && v.css("top", (u.outerHeight(false) - v.outerHeight(false)) / 2);
            if (Rb != ga) {
                Rb = ga;
                P = Math.ceil(Z / (ga * F));
                a.settings.thumbnailButtons && a.settings.thumbnailScrollerResponsive && Pb();
                if (a.settings.thumbnailScrollbar && a.settings.thumbnailScrollerResponsive)if (a.settings.thumbnailOrientation ==
                    "horizontal") {
                    E.css("width", v.width());
        ...
        function lc() {
            ...
            var b = i('<a class="previous"></a>').click(function () {
                jb()
            }).appendTo(na), e = i('<a class="next"></a>').click(function () {
                ib()
            }).appendTo(na);
            if (a.settings.thumbnailOrientation ==
                "horizontal") {
                b.css({top: Math.round((Y * F - b.height()) / 2)});
                e.css({top: Math.round((Y * F - e.height()) / 2)})
            } else {
                b.css({left: Math.round((X * F - b.width()) / 2)});
                e.css({left: Math.round((X * F - e.width()) / 2)})
            }
            if (a.settings.thumbnailArrowsToggle) {
                R == "msie" ? na.hide() : na.css("opacity", 0);
                v.hover(function () {
                    R == "msie" ? na.show() : na.stop().animate({opacity: 1}, a.settings.thumbnailArrowsShowDuration)
                }, function () {
                    R == "msie" ? na.hide() : na.stop().animate({opacity: 0}, a.settings.thumbnailArrowsHideDuration)
                })
            }
        }
        ...
        function Pb() {
            if (!G) {
                ...
                if (a.settings.thumbnailButtonsToggle) {
                    ...
                    v.hover(function () {
                        w ? G.show() : G.stop().animate({opacity: 1}, a.settings.thumbnailButtonsShowDuration)
                    }, function () {
                        w ? G.hide() : G.stop().animate({opacity: 0}, a.settings.thumbnailButtonsShowDuration)
                    })
                }
            }
            if (P == 1)G.empty(); else if (G.find(".buttons a").length != P && P > 1) {
                G.empty();
                for (var b, e = 0; e < P; e++) {
        ...
        function V(b, e) {
            var c = a.settings.thumbnailOrientation == "horizontal" ? D.width() : D.height(), f = b * c;
            L = b;
            if (L == P - 1)f =
                ia - c;
            Sa();
            J.animate(a.settings.thumbnailOrientation == "horizontal" ? {left: -f} : {top: -f}, {
            ...
            Sb = setInterval(function () {
                if (Tb != vb) {
                    ...
                    if (Bb) {
                        Bb = false;
                        if (a.settings.slideArrows &&
                            a.settings.slideArrowsToggle)w ? s.find(".slide-arrows a").stop().show() : s.find(".slide-arrows a").stop().animate({opacity: 1}, a.settings.slideArrowsShowDuration);
                        if (a.settings.slideshowControls && a.settings.slideshowControlsToggle)w ? s.find(".slideshow-controls").stop().show() : s.find(".slideshow-controls").stop().animate({opacity: 1}, a.settings.slideshowControlsShowDuration);
                        if (a.settings.slideButtons && a.settings.slideButtonsToggle)w ? s.find(".slide-buttons").stop().show() : s.find(".slide-buttons").stop().animate({opacity: 1},
                    ...
                    Ab = setTimeout(function () {
                        Bb = true;
                        if (a.settings.slideArrows && a.settings.slideArrowsToggle)w ? s.find(".slide-arrows a").stop().hide() : s.find(".slide-arrows a").stop().animate({opacity: 0}, a.settings.slideArrowsHideDuration);
                        if (a.settings.slideshowControls && a.settings.slideshowControlsToggle)w ? s.find(".slideshow-controls").stop().hide() : s.find(".slideshow-controls").stop().animate({opacity: 0}, a.settings.slideshowControlsHideDuration);
                        if (a.settings.slideButtons &&
        ...
        function Pa() {
            ...
            var b = 0, e = false, c = D.offset().top, f = D.offset().left, g = D.width(), d = D.height(), h = a.settings.thumbnailOrientation == "horizontal" ? g : d, j = a.settings.thumbnailOrientation == "horizontal" ? f : c, p = a.settings.thumbnailOrientation ==
            "horizontal" ? "left" : "top", k = parseInt(J.css(p));
            mb = setInterval(function () {
                ...
                if (Math.abs(b) > 0) {
                    if (k >= 0)k = 0; else if (k <= h - ia)k = h - ia;
                    Ga();
                    J.css(p, k)
                }
            }, 30)
        ...
        function Qb() {
            a.settings.thumbnailMouseWheel =
                true;
            var b = 0, e = a.settings.thumbnailMouseWheelReverse ? -1 : 1, c, f = a.settings.thumbnailOrientation == "horizontal" ? "left" : "top", g = a.settings.thumbnailOrientation == "horizontal" ? D.width() : D.height();
            D.bind("mousewheel", function (d, h) {
                ...
                b += e * h * 10;
                if (b >= 0)b = 0; else if (b <= g - ia)b = g - ia
            })
        }
        ...
        function mc() {
            ...
            function e() {
                if (k < 0)k = 0; else if (k > parseInt(za.css(t)) - parseInt(p.css(t)))k = parseInt(za.css(t)) - parseInt(p.css(t));
                Ua && p.css(z, k);
            ...
            var c = i('<div class="back"></div>').appendTo(E),
                f = i('<div class="track"></div>').appendTo(E), g = i('<div class="forward"></div>').appendTo(E), d = i('<div class="track-middle"></div>').appendTo(f), h = i('<div class="track-back"></div>').appendTo(f), j = i('<div class="track-forward"></div>').appendTo(f), p = i('<div class="thumb"></div>').appendTo(f);
            i('<div class="thumb-middle"></div>').appendTo(p);
            i('<div class="thumb-back"></div>').appendTo(p);
            i('<div class="thumb-forward"></div>').appendTo(p);
            var k = 0, l, n = 0, m = 0, t = a.settings.thumbnailOrientation == "horizontal" ?
                "width" : "height", z = a.settings.thumbnailOrientation == "horizontal" ? "left" : "top";
            E.addClass(a.settings.scrollbarSkin);
            za = f;
            if (a.settings.thumbnailOrientation == "horizontal") {
                E.addClass("horizontal");
                E.css({top: Y * F, left: (v.outerWidth(false) - E.width()) / 2});
                v.css("height", Math.max(v.height(), E.position().top + E.outerHeight(true)))
            } else {
                E.addClass("vertical");
                E.css({left: X * F, top: (v.outerHeight(false) - E.height()) / 2});
            ...
            if (a.settings.thumbnailScrollbarToggle) {
                w ? E.hide() : E.css("opacity", 0);
                v.hover(function () {
                    w ? E.show() : E.stop().animate({opacity: 1}, a.settings.thumbnailScrollbarShowDuration)
                }, function () {
                    w ? E.hide() : E.stop().animate({opacity: 0}, a.settings.thumbnailScrollbarShowDuration)
                })
            }
            p.bind("mousedown",
                function (B) {
        ...
        function Ga() {
            if (a.settings.thumbnailScrollbar && !Ua) {
                var b = za.find(".thumb"), e = a.settings.thumbnailOrientation == "horizontal" ? "left" : "top", c = a.settings.thumbnailOrientation == "horizontal" ? "width" : "height";
        ...
        function jc(b) {
            ...
            if (e) {
                ...
                var f = c.outerWidth(false) / 2, g = c.outerHeight(false) + parseInt(c.css("marginBottom"));
                c.css({left: ka, top: la});
                c.stop(false, true).fadeIn(a.settings.tooltipShowDuration);
                i(document).bind("mousemove.tooltip", function () {
                    c.css({left: ka - f, top: la - g})
                })
            }
        }
        ...
        function fc(b, e, c, f) {
            ...
            switch (e) {
                case "randomPattern":
                    ...
                    break;
                case "topToBottom":
                    for (h = 0; h < f; h++)for (d = 0; d < c; d++)g.push(r(b, d, h));
                    break;
                case "bottomToTop":
                    for (h = f - 1; h >= 0; h--)for (d = c - 1; d >= 0; d--)g.push(r(b, d, h));
                    break;
                case "rightToLeft":
                    for (d = c - 1; d >= 0; d--)for (h = f - 1; h >= 0; h--)g.push(r(b, d, h));
                    break;
                case "leftToRight":
                    for (d = 0; d < c; d++)for (h = 0; h < f; h++)g.push(r(b, d, h));
                    break;
                ...
                case "horizontalMarginToCenter":
                    if (c % 2) {
                        for (d = 0; d < Math.floor(c / 2); d++)for (h = 0; h < f; h++) {
                            g.push(r(b, d, h));
                            g.push(r(b, c - 1 - d, h))
                        }
                        for (e = 0; e < f; e++)g.push(r(b, Math.floor(c / 2), e))
                    } else for (d = 0; d < Math.floor(c / 2); d++)for (h = 0; h < f; h++) {
                        g.push(r(b, d, h));
                        g.push(r(b, c - 1 - d, h))
                    }
                    break;
                case "horizontalCenterToMargin":
                    if (c %
                        2)for (e = 0; e < f; e++)g.push(r(b, Math.floor(c / 2), e));
                    for (d = Math.floor(c / 2) - 1; d >= 0; d--)for (h = 0; h < f; h++) {
                        g.push(r(b, d, h));
                        g.push(r(b, c - 1 - d, h))
                    }
                    break;
                case "verticalMarginToCenter":
                    if (f % 2) {
                        for (h = 0; h < Math.floor(f / 2); h++)for (d = 0; d < c; d++) {
                            g.push(r(b, d, h));
                            g.push(r(b, d, f - 1 - h))
                        }
                        for (e = 0; e < c; e++)g.push(r(b, e, Math.floor(f / 2)))
                    } else for (h = 0; h < Math.floor(f / 2); h++)for (d = 0; d < c; d++) {
                        g.push(r(b, d, h));
                        g.push(r(b, d, f - 1 - h))
                    }
                    break;
                case "verticalCenterToMargin":
                    if (f % 2)for (e = 0; e < c; e++)g.push(r(b, e, Math.floor(f / 2)));
                    for (h = Math.floor(f /
                ...
                case "spiralMarginToCenterCW":
                    ...
                    if (t % 2) {
                        if (t == f)for (d = m++; d < k; d++)g.push(r(b, d, m - 1));
                        if (t == c)for (h = m++; h < l; h++)g.push(r(b, c - m, h))
                    }
                    break;
                case "spiralMarginToCenterCCW":
                    ...
                    if (t % 2) {
                        if (t == f)for (d = m++; d < k; d++)g.push(r(b, d, f - m));
                        if (t == c)for (h = m++; h < l; h++)g.push(r(b, m - 1, h))
                    }
                    break;
        ...
        function Fa(b) {
            var e = parseInt(b.substring(1, 3), 16), c = parseInt(b.substring(3, 5), 16);
            b = parseInt(b.substring(5, 7), 16);
            return {red: e, green: c, blue: b}
        }
        ...
        function Vb(b, e, c) {
            ...
            f = b.apply(window, c);
            e[f] = {args: c, created: Date.now(), cb: g, id: f};
            return f
        }
        ...
        var s = i($), a = this, o = -1, C = -1, sa = -1, y = [], x = [], K = 0, Ca = 0, xa = null, U = false, ab = false, ea = false, Ia = false, Aa = false, Na, ua = false, sb = false, N = false, ha = 0, zb = 0, T, gb = 0, hb = 0, Z = 0, ga = 0, Rb = 0, ia,
            v, D, J, X, Y, na, G, E, za, kb, L = 0, P = 0, F = 0, yb = false, mb, ob, nb = false, Cb, Ua = false, pb = false, ka, la, Tb = 0, vb = 0, Sb, Ab = 0, lb = false, Bb = false, Nb = true, ma = "", Ra = 0, ba = null, O, u, q, Ib, Jb, Hb = 0, fb, Lb, ta = window.navigator.userAgent.toLowerCase(), Ja = ta.match(/ipad/i) != null || ta.match(/ipod/i) != null || ta.match(/iphone/i) != null, nc = /(msie) ([\w.]+)/;
        ta = /(webkit)[ \/]([\w.]+)/.exec(ta) || nc.exec(ta) || [];
        var R = ta[1], ja = ta[2], w = R == "msie" && parseInt(ja) < 9, Ha = false, va = "off", Xa = ["alignType", "effectType", "sliceEffectType", "sliceDelay", "sliceDuration",
                ...
                i.ajax({
                    ...
                    success: function (b) {
                        ...
                        i(e).find("slide").each(function (f) {
                            var g = i('<div class="slide"></div>').appendTo(q), d = i(this), h = d.find("image"), j = d.find("thumbnail"), p = d.find("caption"), k = d.find("html"), l = d.find("layer"), n = d.find("link"), m = d.find("thumbnailLink"), t = h.length || d.attr("data-image"), z, B;
        ...
        this.getSize = function () {
            return {sliderWidth: s.width(), sliderHeight: s.height(), slideWidth: u.width(), slideHeight: u.height()}
        };
        ...
        var Va = {}, Wa = {}, Xb = window.setTimeout, qb = window.setInterval, Yb = window.clearTimeout, Zb = window.clearInterval;
        if (Ja)if (parseFloat(("" + (/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [0, ""])[1]).replace("undefined", "3_2").replace("_", ".").replace("_", "")).toString().indexOf("6.0") != -1) {
    ...
    i.fn.sliderImagesLoaded = function (Q) {
        ...
        function pa(M, I) {
            if (!(M.src === $ || i.inArray(M, La) !== -1)) {
                ...
                i.data(M, "sliderImagesLoaded", {isBroken: I, src: M.src});
        ...
        var da = this, ca = i.isFunction(i.Deferred) ? i.Deferred() : 0, ub = i.isFunction(ca.notify), fa = da.find("img").add(da.filter("img")), La = [], Ma = [], Da = [];
        i.isPlainObject(Q) && i.each(Q, function (M, I) {
            if (M === "callback")Q = I; else ca && ca[M](I)
        });
        fa.length ? fa.bind("load.sliderImagesLoaded error.sliderImagesLoaded", Ya).each(function (M, I) {
            var $a = I.src, Qa = i.data(I, "sliderImagesLoaded");
            if (Qa && Qa.src === $a)pa(I, Qa.isBroken); else if (I.complete && I.naturalWidth !== rb)pa(I, I.naturalWidth ===
                0 || I.naturalHeight === 0); else if (I.readyState || I.complete) {
                I.src = $;
                I.src = $a
            }
        }) : aa();
